// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FlatUI.cs" company="Delirium Products">
//
...
namespace MonoFlat
{
    ...
    public class MonoFlat_ThemeContainer : ContainerControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), new Rectangle(0, 0, Width, 60));
            ...
            if (_RoundCorners == true)
            {
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), 1, 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), 1, 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), 2, 1, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), 3, 1, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), Width - 2, 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), Width - 2, 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), Width - 3, 1, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(217,66,53)), Width - 4, 1, 1, 1);
    ...
    class MonoFlat_ControlBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            base.OnPaint(e);
            Graphics G = e.Graphics;
            G.Clear(Color.FromArgb(217,66,53));
    ...
    public class MonoFlat_Button : Control
    {
        ...
        public MonoFlat_Button()
        {
            ...
            P1 = new Pen(Color.FromArgb(217,66,53)); // P1 = Border color
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(217,66,53), Color.FromArgb(217,66,53), 90.0F);
    ...
    public class MonoFlat_SocialButton : Control
    {
        ...
        {
            base.OnMouseEnter(e);
            EllipseColor = Color.FromArgb(217,66,53);
            Refresh();
        }
        protected override void OnMouseLeave(EventArgs e)
        {
    ...
    public class MonoFlat_LinkLabel : LinkLabel
    {
        ...
        public MonoFlat_LinkLabel()
        {
            ...
            BackColor = Color.Transparent;
            LinkColor = Color.FromArgb(217,66,53);
            ActiveLinkColor = Color.FromArgb(153, 34, 34);
            VisitedLinkColor = Color.FromArgb(217,66,53);
    ...
    public class MonoFlat_Toggle : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (_Toggled)
            {
                ...
                GP2 = RoundRectangle.RoundRect(ThumbRect, 4);
                G.FillPath(new SolidBrush(Color.FromArgb(217,66,53)), GP);
                G.FillPath(new SolidBrush(Color.FromArgb(32, 41, 50)), GP2);
            }
    ...
    public class MonoFlat_CheckBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Enabled == true)
            {
                if (_Checked)
                {
                    G.DrawString("a", new Font("Marlett", 16), new SolidBrush(Color.FromArgb(217,66,53)), new Point(-5, -3));
                }
            }
            else
            {
    ...
    public class MonoFlat_RadioButton : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_Checked)
            {
                G.DrawString("a", new Font("Marlett", 15), new SolidBrush(Color.FromArgb(217,66,53)), new Point(-3, -2));
            }
    ...
    public class MonoFlat_TextBox : Control
    {
        ...
        {
            P1 = new Pen(Color.FromArgb(217,66,53));
            Refresh();
        }
